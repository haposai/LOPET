    ...
    public partial class perfil : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                user.LopeDni = Session["DNI"] as string;
                ...
                txt_nombre.Text = Session["Nombre"] as string;
                txt_apellido.Text = Session["Apellido"] as string;
                txt_dni.Text = Session["DNI"] as string;
                txt_celular.Text = Session["Celular"] as string;
                txt_correo.Text = Session["Correo"] as string;
                txt_precio.Text = Session["Precio"] as string;
                txt_des.Text = Session["Descripcion"] as string;
                string distrito = Session["Distrito"] as string;
                string servicio = Session["Servicio"] as string;
                ...
                string clave = Session["Clave"] as string;
                txt_con.Text = Encriptar(clave);
                //txt_con.TextMode = TextBoxMode.Password;
                ddl_sexo.Text = Session["Sexo"] as string;
        ...
        protected void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            {
                user.LopeFotoPer = Session["Foto_Perfil"] as string;
            }
            ...
            {
                user.LopeFotoPor = Session["Foto_Portada"] as string;
            }
