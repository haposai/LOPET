<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Registrar_Dueño.aspx.cs" Inherits="Lopet.Admin.Registrar_Dueño" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <script type="text/javascript">
      ...
      <h3 class="box-title" style="color:midnightblue">Registrar Dueño</h3>
