<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ModificarLopet.aspx.cs" Inherits="Lopet.Admin.ModificarLopet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
     ...
     <h3 class="box-title" style="color:midnightblue">Editar Lopet</h3>
