    ...
    public partial class perfil : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                user.UsuDni = Session["DNI"] as string;
        ...
        protected void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            {
                user.UsuFotoPer = Session["Foto_Perfil"] as string;
            }
            ...
            {
                user.UsuFotoPor = Session["Foto_Portada"] as string;
            }
            ...
            if (rpta == -1 || rpta == 1)
            {
                Response.Redirect("/Dueno/perfil.aspx");
            }
            else
            {
